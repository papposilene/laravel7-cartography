<!-- Modal: modalCategoriesImport -->
<div class="modal fade" id="modalCategoriesImport" tabindex="-1" role="dialog" aria-labelledby="modalCategoriesImportTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="POST" action="{{ route('admin.category.import') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCategoriesImportTitle">
                        @ucfirst(__('app.categoryImport'))
                    </h5>
